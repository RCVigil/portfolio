  ...
  return (
    <section className="divImgNoteb">
      <div className="pImgNote">
        ...
        <p className="p-saudacao">
          Aqui, você encontrará uma variedade de serviços que posso
          oferecer, desde o desenvolvimento de sites e aplicações web até a
          consultoria em projetos complexos. Cada projeto é tratado com
          dedicação e atenção aos detalhes, garantindo que suas necessidades
        ...
        <p className="p-saudacao">
          ...
          com você em seu próximo projeto. Estou animado para fazer parte do
          seu sucesso e ajudá-lo(a) a alcançar resultados incríveis.
        </p>
