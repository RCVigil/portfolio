  ...
  return (
    <div className="divSobre">
      <div className="textoSobre">
        <h1 className="titleSobre">Desenvolvedor Full-Stack</h1>
        <p className="user-select-none float-sm-start parSobre">
          ...
          da tecnologia e já estou com o certificado de Front-End e Back-End.
        </p>
      </div>
    </div>
  );
